    ...
    >
      ...
      >
        ...
        >
          ...
          <div v-motion-slide-visible-once-left class="flex flex-col gap-2">
          ...
          <div class="grid gap-6 p-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <div class="flex items-center gap-4">
                ...
                <h5 class="text-base sm:text-lg lg:text-xl font-bold">
                  Fleksibilitas Donasi
                </h5>
              </div>
              <p class="mt-3 font-normal text-gray-500">
                Donatur dapat menyumbang dalam bentuk barang, pangan, tenaga,
                maupun dana.
              </p>
            </div>
            ...
            >
              <div class="flex items-center gap-4">
                ...
                <h5 class="text-base sm:text-lg lg:text-xl font-bold">
                  Janji Temu <i>Offline</i>
                </h5>
              </div>
              <p class="mt-3 font-normal text-gray-500">
                Donasi dapat difasilitasi secara online maupun pertemuan
                langsung untuk interaksi yang personal dengan panti asuhan.
              </p>
            </div>
            ...
            >
              ...
              <p class="mt-3 font-normal text-gray-500">
                Memiliki akses pada fitur manajemen donasi yang komprehensif,
                termasuk laporan, riwayat donasi, dan profil informasi.
              </p>
            </div>
            ...
            >
              ...
              <p class="mt-3 font-normal text-gray-500">
                Donatur dapat menambahkan pesan khusus untuk panti asuhan
            ...
            >
              <div class="flex items-center gap-4">
                ...
                <h5 class="text-base sm:text-lg lg:text-xl font-bold">
                  Transaparansi Donasi
                </h5>
              </div>
              <p class="mt-3 font-normal text-gray-500">
                Transparansi dalam setiap proses donasi diutamakan untuk
                memastikan kepercayaan semua pihak.
              </p>
            </div>
          </div>
          ...
          <div v-motion-slide-visible-once-left>
            <p>
              Kami percaya bahwa dengan bersama-sama, kita dapat menciptakan
              dampak positif yang berkelanjutan bagi komunitas. BestiePanti ada
              untuk menjadikan proses berbagi lebih mudah dan terarah, sehingga
              kebaikan dapat menjangkau mereka yang membutuhkan.
            </p>
          </div>
