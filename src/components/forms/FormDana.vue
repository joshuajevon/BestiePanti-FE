        ...
        <div class="flex w-full flex-col items-start justify-center gap-6">
          ...
          <div class="input-container mt-2">
            ...
            <div class="flex items-center justify-center w-full">
              <label
                for="proof_of_payment"
                class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-3xl cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
              >
